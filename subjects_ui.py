...
# Form implementation generated from reading ui file 'D:\Projects\ARM_s_CPUI\interface/subjects_ui.ui'
#
...
class Ui_Subjects(object):
    ...
    def retranslateUi(self, Subjects):
        ...
        self.label_sub_tax.setText(_translate("Subjects", "Преподавательская часовая такса рублей"))
        self.label_sub_teach.setText(_translate("Subjects", "Преподаватель"))
        self.label_sub_price.setText(_translate("Subjects", "Месячная стоимость рублей"))
