...
class Ui_Contract(object):
    def setupUi(self, Contract):
        ...
        self.widget_groups = QtWidgets.QWidget(Contract)
        self.widget_groups.setObjectName("widget_groups")
        self.hL_widget_groups = QtWidgets.QHBoxLayout(self.widget_groups)
        self.hL_widget_groups.setObjectName("hL_widget_groups")
        self.vL_main.addWidget(self.widget_groups)

        self.lab_group = QtWidgets.QLabel(Contract)
        self.lab_group.setObjectName("lab_group")
        self.hL_widget_groups.addWidget(self.lab_group)

        self.comboBox_group = QtWidgets.QComboBox(Contract)
        self.comboBox_group.setObjectName("comboBox_group")
        self.hL_widget_groups.addWidget(self.comboBox_group)
        ...
        self.widget_inn_parent = QtWidgets.QWidget(Contract)
        self.widget_inn_parent.setObjectName("widget_inn_parent")

        self.hL_widget_inn_parent = QtWidgets.QHBoxLayout(self.widget_inn_parent)
        self.hL_widget_inn_parent.setObjectName("hL_widget_inn_parent")
        self.vL_main.addWidget(self.widget_inn_parent)

        self.lab_inn_parent = QtWidgets.QLabel(Contract)
        self.lab_inn_parent.setObjectName("lab_inn_parent")
        self.hL_widget_inn_parent.addWidget(self.lab_inn_parent)

        self.lEdit_inn_parent = QtWidgets.QLineEdit(Contract)
        self.lEdit_inn_parent.setObjectName("lEdit_inn_parent")
        self.hL_widget_inn_parent.addWidget(self.lEdit_inn_parent)
    ...
    def retranslateUi(self, Contract):
        ...
        self.lab_group.setText(_translate("Contract", "Группа: "))
        ...
        self.lab_passport_parent_whom.setText(_translate("Contract", "Кем выдан паспорт заказчика: "))
        self.lab_fullname.setText(_translate("Contract", "ФИО обучающегося: "))
        self.lab_fullname_parent.setText(_translate("Contract", "ФИО заказчика: "))
        ...
        self.lab_phone.setText(_translate("Contract", "Телефон обучающегося: "))
        self.lab_phone_parent.setText(_translate("Contract", "Телефон заказчика: "))
        self.checkBox_add_new_stud.setText(_translate("Contract", "Сразу добавить обучающегося в реестр"))
        self.lab_mail.setText(_translate("Contract", "Электронная почта обучающегося: "))
        self.lab_passport.setText(_translate("Contract", "Паспорт обучающегося (серия, номер, дата выдачи): "))
        self.lab_inn_parent.setText(_translate("Contract", "Инн заказчика"))
        self.lab_passport_parent.setText(_translate("Contract", "Паспорт заказчика (серия, номер, дата выдачи): "))
        self.lab_mail_parent.setText(_translate("Contract", "Электронная почта заказчика: "))
