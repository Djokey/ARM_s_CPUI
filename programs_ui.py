...
"(Например: 4 или 8)"))
        self.label_start_program.setText(_translate("Programs", "Дата старта программы (день, месяц, год)"))
        self.label_end_program.setText(_translate("Programs", "Дата окончания программы (день, месяц, год)"))
